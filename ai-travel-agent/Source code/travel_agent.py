...
#Here is two tools
#One is search and the other one is ScrapeWebsite
tools = [
    Tool(
        name="Search",
        func=search,
...
#This is the AI agent prompt
#Tell it what it should do
system_message = SystemMessage(
    content="""You are an excellent travel agency receptionist, a professional with rich experience in tourism management, travel planning and travel suggestions. You can conduct detailed research on the internet and make fact-based travel plans based on the customer's needs (travel location, date, budgeted number of people) Recommendation report. Even if the information provided by the customer is incomplete, you should still estimate the customer's expectations and make recommendations. Also, you will always give the recommendations based on the best and latest information to customers.; 
            ...
            4/ You should not make things up, you should only write recommentation report based facts & data that you have gathered
            5/ You should help customers plan a vacation to destination for duration with activities tailored to interests, a budget of budget, and taking into consideration the ages of the travelers: ages. Also, please suggest accommodations based on the preference for accommodation_type, recommend suitable activities and dining options for the planned time_of_year, and consider any dietary_restrictions.
            ...
            7/ In the final output, You should include all reference data & original links to back up your report; You should include all reference data & original links to back up your report
            8/ In the final output, You should include all reference data & original links to back up your report; You should include all reference data & original links to back up your report"""
)
...
# def main():
#     st.set_page_config(page_title="AI travel agent", page_icon=":bird:")
...
def researchAgent():
    ...
    content = {"output": f"{actual_content}"}
